...
const strings = {
  pt: {
    preview: 'Recebemos o teu pedido de consulta — Desassossego',
    title: 'Pedido recebido',
    greeting: (name?: string) => (name ? `Olá ${name},` : 'Olá,'),
    body: 'Obrigado pelo teu pedido de consulta. Recebemos a tua mensagem e a nossa equipa irá responder-te o mais brevemente possível.',
    summaryTitle: 'Resumo do pedido',
    service: 'Serviço',
    location: 'Localização',
    schedule: 'Horário preferido',
    closing:
      'Se precisares de alterar algum dado, responde diretamente a este e-mail.',
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    data?.lang === 'en'
      ...
      : 'Recebemos o teu pedido de consulta',
