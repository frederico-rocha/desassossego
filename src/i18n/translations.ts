...
const pt = {
    ...
    team: {
      ...
      francis: {
        ...
        bio: [
          ...
          "Professora Auxiliar na Universidade Europeia - Instituto Universitário.<br />Professora Universitária no ISPA - Instituto Universitário (2018-2026).<br />Membro do Conselho Fiscal da IA - Identidades e Afectos, Associação. Psicoterapia a pessoas LGBTQIA+ e familiares.",
  ...
  booking: {
    ...
    service: "Serviço pretendido (opcional)",
    select: "Selecionar...",
    ...
    team: {
      ...
      francis: {
        ...
        bio: [
          ...
          "Assistant Professor at the Universidade Europeia - Instituto Universitário.<br />Professor at the ISAP - Instituto Universitário (2018-2026).<br />Member of the Supervisory Board of IA - Identidades e Afectos, Associação. Psychotherapy for LGBTQIA+ people and their families.",
