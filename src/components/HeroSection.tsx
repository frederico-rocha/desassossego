...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[760px] lg:min-h-screen flex items-start lg:items-end overflow-hidden pt-[calc(60vw+6rem)] sm:pt-[calc(68vw+5rem)] md:pt-[calc(35vw+5rem)] lg:pt-0 pb-10 md:pb-6 lg:pb-24">
      <div
