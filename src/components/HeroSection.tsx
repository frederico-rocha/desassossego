...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[760px] lg:min-h-screen flex items-start lg:items-end overflow-hidden pt-[88vw] sm:pt-[68vw] lg:pt-0 pb-10 lg:pb-24">
      <div
        className="absolute inset-x-0 top-0 h-[88vw] sm:h-[68vw] lg:inset-0 lg:h-auto bg-contain lg:bg-cover bg-top bg-no-repeat bg-secondary"
