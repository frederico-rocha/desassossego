  ...
  return (
    <section id="contactos" className="section-padding bg-background">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-semibold text-foreground mb-4">{t.contacts.title}</h2>
          <p className="text-muted-foreground font-body text-lg">{t.contacts.subtitle}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-5">
          {[
            ...
            },
            {
              ...
              lines: ["geral@clinicadesassossego.pt"],
            },
            {
              icon: Clock,
            ...
            },
            {
              icon: MapPin,
              title: "Cascais",
              lines: ["Av. 25 de Abril, Edif. Alvorada,", "672, 5A, Sala 7", "2750-512 Cascais"],
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
